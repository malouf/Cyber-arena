  ...
  return (
    <main className="min-h-screen bg-black text-neutral-100 flex flex-col font-sans overflow-hidden relative">
      ...
      <header className="px-12 py-10 border-b border-neutral-900">
        <h1 className="text-6xl font-black tracking-tighter text-white uppercase mb-2">
          Arena<span className="text-red-600">.</span>Async
        </h1>
        <p className="text-neutral-500 font-mono text-xs tracking-[0.3em] uppercase">
          Tactical Duel • V1.0.0
        </p>
      </header>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-4xl">
          <div className="mb-12 text-center">
            <h2 className="text-sm font-bold text-red-600 uppercase tracking-[0.3em] mb-2">
              Select Game Mode
            </h2>
            <p className="text-neutral-500 text-xs uppercase tracking-widest">
              Connect to the simulation network
            </p>
          </div>
            ...
            {modes.map((mode) =>
              mode.locked ? (
                ...
                >
                  ...
                  <p className="text-neutral-400 text-sm font-mono leading-relaxed mt-auto">
                    {mode.desc}
                  </p>
                </div>
              ) : (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-red-600 animate-pulse">
                      {mode.status}
                    </span>
                  </div>
                  <p className="text-neutral-400 text-sm font-mono leading-relaxed mt-auto group-hover:text-neutral-300 transition-colors">
                    {mode.desc}
                  </p>
